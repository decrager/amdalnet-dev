export default {
  ...
  permission: {
    ...
    name: {
      ...
      'view menu project on process': 'view menu project on process',
      'view menu project issued': 'view menu project issued',
      'view menu lpjp': 'view menu lpjp',
      'view menu formulator expert': 'view menu formulator expert',
      'view menu formulator team': 'view menu formulator team',
      'view menu luk': 'view menu luk',
      'view menu configuration': 'view menu configuration',
      'view menu component': 'view menu component',
      'view menu env params': 'view menu env params',
      'view menu profile': 'view menu profile',
      'view menu examiner team': 'view menu examiner team',
      'manage lpjp': 'manage lpjp',
      'manage formulator team': 'manage formulator team',
      'manage luk': 'manage luk',
      'manage component': 'manage component',
      'manage env params': 'manage env params',
      'do formulator team': 'do formulator team',
      'do examiner team': 'do examiner team',
      'do public consultation': 'do public consultation',
      'do KA draft & submit': 'do KA draft & submit',
      'do KA approve': 'do KA approve',
      'do KA resubmit': 'do KA resubmit',
      'do ANDAL draft & submit': 'do ANDAL draft & submit',
      'do ANDAL approve': 'do ANDAL approve',
      'do RKL/RPL activities': 'do RKL/RPL activities',
      ...
      'do UKL': 'do UKL',
      'do UPL': 'do UPL',
      'do AMDAL submit': 'do AMDAL submit',
      'do AMDAL review': 'do',
      'do AMDAL approve': 'do AMDAL approve',
      'do UKL/UPL submit': 'do UKL/UPL submit',
      'do UKL/UPL review': 'do UKL/UPL review',
      'do UKL/UPL approve': 'do UKL/UPL approve',
      'do Generate SK PKPLH': 'do Generate SK PKPLH',
      'do Generate SK SKKL': 'do Generate SK SKKL',
      'do Push To OSS': 'do Push To OSS',
      ...
      'view menu examiner secretary': 'view menu kepala sekretariat',
