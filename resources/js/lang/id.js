export default {
  ...
  roles: {
    title: {
      ...
      'admin-standard': 'admin umum',
      examiner: 'penguji',
      'examiner-institution': 'Lembaga Penguji',
      'admin-system': 'sistem admin',
      'admin-central': 'admin pusat',
      'admin-regional': 'admin regional',
      public: 'Publik',
      'formulator-chief': 'Penyusun Ketua',
      'formulator-member': 'Penyusun Anggota',
      ...
      'examiner-substance': 'Ahli Subtansi',
