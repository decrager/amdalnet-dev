    ...
    <el-form-item label="Peta Batas Ekologis" :required="required">
      <el-col :span="11" style="margin-right:1em;">
        ...
        <fieldset style="border:1px solid #e0e0e0; border-radius: 0.3em; width:100%; padding: .5em;">
          <legend style="margin:0 2em;">File-File SHP yang suda di-zip
          ...
          <form @submit.prevent="handleSubmit">
            <input ref="peSHP" :disabled="readonly" type="file" class="form-control-file" @change="onChangeFiles(1)">
      ...
      <el-col :span="11" style="margin-right:1em;">
        <fieldset style="border:1px solid #e0e0e0; border-radius: 0.3em; width:100%; padding: .5em;">
          ...
          <form @submit.prevent="handleSubmit">
            <input ref="pePDF" :disabled="readonly" type="file" class="form-control-file" accept="application/pdf" @change="onChangeFiles(2)">
            <!-- <button type="submit">Unggah</button> -->
          </form>
        </fieldset>
      </el-col>
    ...
    <el-form-item label="Peta Batas Sosial" :required="required">
      <el-col :span="11" style="margin-right:1em;">
        <fieldset style="border:1px solid #e0e0e0; border-radius: 0.3em; width:100%; padding: .5em;">
          ...
          <form @submit.prevent="handleSubmit">
            <input ref="psSHP" :disabled="readonly" type="file" class="form-control-file" @change="onChangeFiles(3)">
            <!-- <button type="submit">Unggah</button> -->
          </form>
        </fieldset>
      ...
      <el-col :span="11" style="margin-right:1em;">
        <fieldset style="border:1px solid #e0e0e0; border-radius: 0.3em; width:100%; padding: .5em;">
          ...
          <form @submit.prevent="handleSubmit">
            <input ref="psPDF" :disabled="readonly" type="file" class="form-control-file" accept="application/pdf" @change="onChangeFiles(4)">
            <!-- <button type="submit">Unggah</button> -->
          </form>
        </fieldset>
      </el-col>
    ...
    <el-form-item label="Peta Batas Wilayah Studi" :required="required">
      <el-col :span="11" style="margin-right:1em;">
        <fieldset style="border:1px solid #e0e0e0; border-radius: 0.3em; width:100%; padding: .5em;">
          ...
          <form @submit.prevent="handleSubmit">
            <input ref="pwSHP" :disabled="readonly" type="file" class="form-control-file" @change="onChangeFiles(5)">
            <!-- <button type="submit">Unggah</button> -->
          </form>
        </fieldset>
      </el-col>
      ...
      <el-col :span="11" style="margin-right:1em;">
        <fieldset style="border:1px solid #e0e0e0; border-radius: 0.3em; width:100%; padding: .5em;">
          ...
          <form @submit.prevent="handleSubmit">
            <input ref="pwPDF" :disabled="readonly" type="file" class="form-control-file" accept="application/pdf" @change="onChangeFiles(6)">
            <!-- <button type="submit">Unggah</button> -->
          </form>
        </fieldset>
      </el-col>
