        ...
        <tbody>
          <tr>
            <td>
              ...
              <el-button v-if="!isAndal" :disabled="readonly" icon="el-icon-plus" circle style="margin-top:3em;display:block;" round @click="handleAddComponent()" />
            </td>
            <td>
              ...
              <el-button v-if="!isAndal" :disabled="readonly" icon="el-icon-plus" circle style="margin-top:3em;display:block;" round @click="handleAddRonaAwal(1)" />
            </td>
            <td>
              ...
              <el-button v-if="!isAndal" :disabled="readonly" icon="el-icon-plus" circle style="margin-top:3em;display:block;" round @click="handleAddRonaAwal(2)" />
            </td>
            <td>
              ...
              <el-button v-if="!isAndal" :disabled="readonly" icon="el-icon-plus" circle style="margin-top:3em;display:block;" round @click="handleAddRonaAwal(3)" />
            </td>
            <td>
              ...
              <el-button v-if="!isAndal" :disabled="readonly" icon="el-icon-plus" circle style="margin-top:3em;display:block;" round @click="handleAddRonaAwal(4)" />
            </td>
            <td>
              ...
              <el-button v-if="!isAndal" :disabled="readonly" icon="el-icon-plus" circle style="margin-top:3em;display:block;" round @click="handleAddRonaAwal(5)" />
            </td>
            <td>
              ...
              <el-button v-if="!isAndal" :disabled="readonly" icon="el-icon-plus" circle style="margin-top:3em;display:block;" round @click="handleAddRonaAwal(6)" />
            </td>
          </tr>
        </tbody>
      </table>
