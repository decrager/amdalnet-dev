...
const rdtrAceh = new MapImageLayer({
...
const rdtrSumsel = new MapImageLayer({
...
const rdtrNTB = new MapImageLayer({
...
const rdtrKalsel = new MapImageLayer({
...
const rdtrKaltara = new MapImageLayer({
...
const rdtrSulteng = new MapImageLayer({
