...
class CreateFeasibilityTestTeamMembersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('feasibility_test_team_members', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('feasibility_test_team_members');
    }
}
