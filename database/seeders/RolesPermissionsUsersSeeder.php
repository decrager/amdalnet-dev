...
class RolesPermissionsUsersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $aprole->syncPermissions([
            ...
            Acl::PERMISSION_VIEW_MENU_RONA_AWAL,
            Acl::PERMISSION_VIEW_MENU_TUK_MEMBER_LIST,
            Acl::PERMISSION_VIEW_MENU_MATERIALS_AND_POLICIES,
            Acl::PERMISSION_VIEW_MENU_PERMISSION_LIST,
            Acl::PERMISSION_VIEW_MENU_ENV_APPROVE,
            Acl::PERMISSION_VIEW_MENU_UKL_UPL,
            Acl::PERMISSION_VIEW_MENU_SOP_MANAGEMENT,
            Acl::PERMISSION_VIEW_MENU_VIDEO_TUTORIAL,
            Acl::PERMISSION_VIEW_MENU_TUK_MANAGEMENT,
            Acl::PERMISSION_VIEW_MENU_TUK_PROFILE,
            Acl::PERMISSION_VIEW_MENU_TUK_PROJECT,
            ...
            Acl::PERMISSION_MANAGE_RONA_AWAL,
            Acl::PERMISSION_MANAGE_TUK_MEMBER_LIST,
            Acl::PERMISSION_MANAGE_MATERIALS_AND_POLICIES,
            Acl::PERMISSION_MANAGE_PERMISSION_LIST,
            Acl::PERMISSION_MANAGE_ENV_APPROVE,
            Acl::PERMISSION_MANAGE_UKL_UPL,
            Acl::PERMISSION_MANAGE_SOP_MANAGEMENT,
            Acl::PERMISSION_MANAGE_VIDEO_TUTORIAL,
            Acl::PERMISSION_MANAGE_TUK_MANAGEMENT,
            Acl::PERMISSION_MANAGE_TUK_PROFILE,
            Acl::PERMISSION_MANAGE_TUK_PROJECT,
        ]);
